...
-- added Eq for test error:
-- No instance for (Eq Puzzle) arising from a use of ‘shouldBe’
...
freshPuzzle getWord = Puzzle getWord (map (const Nothing) getWord) []

charInWord :: Puzzle -> Char -> Bool
charInWord (Puzzle getWord _ _) guessChar = 
  elem guessChar getWord
